...
// in simulator we redefine to format for riverLevel Developer console
...
{\
	NSString * exceptionName = [@"org.riverlevel." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.riverlevel";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIriverLevelNativeItemNone = -1, 
	UIriverLevelNativeItemSpinner = -2,
	UIriverLevelNativeItemProgressBar = -3,
	
	UIriverLevelNativeItemSlider = -4,
	UIriverLevelNativeItemSwitch = -5,
	UIriverLevelNativeItemMultiButton = -6,
	UIriverLevelNativeItemSegmented = -7,
	
	UIriverLevelNativeItemTextView = -8,
	UIriverLevelNativeItemTextField = -9,
	UIriverLevelNativeItemSearchBar = -10,
	
	UIriverLevelNativeItemPicker = -11,
	UIriverLevelNativeItemDatePicker = -12,
	
	UIriverLevelNativeItemInfoLight = -13,
	UIriverLevelNativeItemInfoDark = -14,
	
	UIriverLevelNativeItemDisclosure = -15,
	
	UIriverLevelNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all riverLevel instances of
