...
@interface riverLevelObject : KrollCoverageObject {
#else
@interface riverLevelObject : KrollObject {
#endif
@private
...
extern NSString * riverLevel$ModuleRequireFormat;
